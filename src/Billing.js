...
const Billing = () => {
  const mockConsultantPayouts = [
    { id: 1, name: 'John Doe', method: 'PayPal', schedule: 'Biweekly', balance: '$500' },
    { id: 2, name: 'Jane Smith', method: 'Bank Transfer', schedule: 'Monthly', balance: '$700' },
  ];
    ...
    <div className="content-wrapper">
      ...
      <section className="content">
        <div className="container-fluid">
          ...
          <div className="card">
            <div className="card-body">
              <button className="btn btn-primary" onClick={handleSetupPaymentIntegration}>Set up Payment Integration</button>
            </div>
          </div>
        </div>
      </section>
